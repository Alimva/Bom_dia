...
"Eu vejo ele mexendo no computador, com algumas sacolas espalhadas pela mesa. Eu espio uma delas e vejo um pacote de unhas postiças, duas garrafas de água e um microfone profissional",
"Tá fazendo o quê?",
"Editando um rótulo de garrafa de água. Eu coloco parte do assunto nela e leio durante a prova",
"Depois eu vou pintar algumas fórmulas nas unhas que eu vou usar no dia e gravar um resumo pra ouvir durante a prova",
"...Wow. Eu consigo pintar bem então eu posso ir adiantando as unhas.",
"Ele me entrega dois pacotes de unhas, esmaltes e uma lista de fórmulas separadas por assunto.",
"Depois de uma hora escrevendo eu olho para o lado onde ele colocou um caderno aberto",
"Várias anotações e resumos apertados para caber nas páginas",
"Todos relacionados a... comida?",
"Os resumos da revolução francesa são interropidos por uma receita detalhada de baba au rhum, a explicação curta de misturas esmagada no canto da folha relaciona isso a água de macarrão",
"Até o rótulo das garrafas de água tem uma referência a latas de leite condensado para explicar um tipo específico de cilindro",
...
"S/N, Desde que eu te vi pela primeira vez eu soube que você era diferente.",
"Você não era como as Princesas que só pensam em poder, nem era esnobe como as outras alunas.",
"E ontem a noite... Bom você foi a primeira pessoa a brigar comigo daquele jeito.",
"Essa foi a primeira vez que eu me arrependi de alguma das besteiras que eu fiz.",
"Você pode me transformar em alguém melhor. O que você fez ontem foi melhor que anos de terapia. Talvez se eu te encontrasse mais cedo eu ainda teria meu réu primário",
